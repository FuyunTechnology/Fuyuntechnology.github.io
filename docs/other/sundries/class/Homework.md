...
permalink: /other/sunderies/class/Homework/
backtotop: false
passwordHint: 请输入班级名
sidebar: false
pageLayout: home
...
- 宣誓词
  ...
  课堂专注凝神，课后勤思善问，把每一次练习都当作实战！

  错题及时复盘，漏洞全力补上，让每一个目标都落地生芒！
...
**高考全部范围,选必下第四单元及相应课外材料。默写来自以下篇目课标要求背诵篇或段:《拟行路难》,《客至》,《登快阁》,《临安春雨初霁》,《菩萨蛮•小山重叠金明灭》,《苏幕遮燎沉香》《青玉案•元夕》。《贺新郎•国脉微如缕》:《长亭送别》,《山居秋暝》。《礼记•大道之行也》。《任安书》(节选)。《种树郭囊驼传》。《石钟山记》,《归去来兮辞(并序))**
...
**高考全部范围(其中选必三全册30分,集合与逻辑、函数与导数,三角函数与三角恒等变换70分,其余内容50分)**
1. **试卷答案在1.1 集合的概念 学习补给站**
2. ==**完成考点集训和名师导学集训8**==
...
- 课程相关
  ...
  ::: card-grid
  <LinkCard title="课表" href="classisland://app/profile/"  />
  <LinkCard title="调课" href="classisland://app/class-swap"  />
  :::

- ClassIsland

  ::: card-grid
  <LinkCard title="时钟" href="classisland://app/settings/clock"  />
  <LinkCard title="组件" href="classisland://app/settings/components"  />
  <LinkCard title="自动化" href="classisland://app/settings/	automation"  />
  <LinkCard title="插件" href="classisland://app/settings/classisland.plugins"  />
  :::
:::::
...
**高考全部范围,其中电磁振荡与电磁波、传感器(5分左右),热学(10分左右),原子和原子核(5分左右),运动学和静力学(15分左右),动力学(20分左右),曲线运动(10分左右),其它内容35分左右。**
...
**高考全部范围(必修一,必修二第一,二、四章)20分,选必一(25分),选必二(15分)、(选必三+必修二第三章)(40分)**
...
**高考全部范围(必修一35分,必修二10分,选必一10分,选必二10分,选必三35分)**
